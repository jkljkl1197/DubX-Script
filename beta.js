setTimeout(function(){ 
	...
	if(!dubX) {
		...
		//Ref 4: chatLog
		function chatLog(e){var a=new Dubtrack.View.chatLoadingItem;a.$el.text(e).appendTo(Dubtrack.room.chat._messagesEl)}chatLog('Running DubX V .1.0 - Spaghetti Regretti?');
