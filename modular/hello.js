if(!dubX){
	...
	var dubX = true;
		setTimeout(function(){ 
            ...
            $.getScript(GitHubLocation + 'optionOnBeforeUnload.js', returnOk);
            $.getScript(GitHubLocation + 'optionShutDown.js', returnOk);
